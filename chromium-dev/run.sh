...
exec "$YEE_BROWSER_BIN" \
  ...
  --enable-features=GlassFrame:GlassTintOpacityForLightMode/0.38/GlassTintOpacityForDarkMode/0.72/GlassExpandOnHoverOpacity/0.72/GlassExpandOnHoverBlurRadius/18.0 \
