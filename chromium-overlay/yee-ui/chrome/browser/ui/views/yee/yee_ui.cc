...
class YeeShellBackground : public views::Background {
 public:
  ...
  void Paint(gfx::Canvas* canvas, views::View* view) const override {
    ...
    surface_flags.setColor(yee::ResolveBrowserSurfaceHeaderColor(
...
class YeeCombinedSurfaceOutlineView : public views::View {
 ...
 public:
  ...
  void OnPaint(gfx::Canvas* canvas) override {
    ...
    surface_rect.Inset(0.5f);
    const SkColor surface_color = yee::ResolveBrowserSurfaceHeaderColor(
        *GetColorProvider(), page_surface_color_callback_.Run());
    const SkColor outline_color =
        color_utils::BlendTowardMaxContrast(surface_color, 0x18);
    const SkColor separator_color =
        color_utils::BlendTowardMaxContrast(surface_color, 0x14);
    ...
    if (separator_y > surface_rect.y() && separator_y < surface_rect.bottom()) {
